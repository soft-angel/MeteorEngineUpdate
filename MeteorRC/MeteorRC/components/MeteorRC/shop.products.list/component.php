...
if($arParams["SEF_URL_TEMPLATES"]["SEF_URL_PAGE"] == $APPLICATION->GetUrlPatch()){
	...
	if(!empty($arElement)){
		...
		$sectionID = (is_array($arElement["SECTION"]))?$arElement["SECTION"][0]:$arElement["SECTION"];
		$arSection = (isset($arResult["SECTIONS"][$sectionID]))?$arResult["SECTIONS"][$sectionID]:array();
