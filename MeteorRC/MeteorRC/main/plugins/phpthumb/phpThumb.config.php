...
$PHPTHUMB_CONFIG['cache_directory'] = realpath('../../../cache/phpthumb/');                            // set the cache directory relative to the phpThumb() installation
...
$PHPTHUMB_CONFIG['high_security_password']   = 'FDFdfdfdw43544';     // required if 'high_security_enabled' is true, must be at least 5 characters long
...
$PHPTHUMB_CONFIG['http_fopen_timeout']              = 20;   // timeout (in seconds) for fopen / curl / fsockopen
$PHPTHUMB_CONFIG['http_follow_redirect']            = false; // if true (default), follow "302 Found" redirects to new URL; if false, return error message
